...
t_set = DigitImage(t_root, t_label, transform=transforms.Compose([
                       transforms.ToTensor(),
                       transforms.Normalize((0.1307,), (0.3081,))
                   ]))

kwargs = {'num_workers': 1, 'pin_memory': True} if args.cuda else {}                 
train_loader = torch.utils.data.DataLoader(t_set, batch_size=args.batch_size, shuffle=True, **kwargs)
...
print("saving model....")
torch.save(model.state_dict(), os.path.join(args.save_dir, 'mnist_bn.pth'))
